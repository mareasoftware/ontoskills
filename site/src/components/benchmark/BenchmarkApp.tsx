...
const DATA: ComparisonData = {
  ...
  "date": "2026-04-30",
  "traditional": {
    "pass_rate": 0.391, "avg_reward": 0.504, "tasks_passed": 9, "total_tasks": 23,
    "avg_input_tokens": 20411, "avg_output_tokens": 7795, "total_cost_usd": 10.70,
    "tasks_partial": 4, "tasks_failed": 10,
  },
  "ontoskills": {
    "pass_rate": 0.478, "avg_reward": 0.561, "tasks_passed": 11, "total_tasks": 23,
    "avg_input_tokens": 15111, "avg_output_tokens": 5703, "total_cost_usd": 7.11,
    "tasks_partial": 3, "tasks_failed": 9,
  },
  "per_task": [
    {"task_id": "3d-scan-calc", "traditional_reward": 1.000, "ontoskills_reward": 1.000, "traditional_passed": true, "ontoskills_passed": true},
    {"task_id": "adaptive-cruise-control", "traditional_reward": 0.000, "ontoskills_reward": 0.000, "traditional_passed": false, "ontoskills_passed": false},
    {"task_id": "earthquake-plate-calc", "traditional_reward": 1.000, "ontoskills_reward": 1.000, "traditional_passed": true, "ontoskills_passed": true},
    {"task_id": "econ-detrending", "traditional_reward": 1.000, "ontoskills_reward": 1.000, "traditional_passed": true, "ontoskills_passed": true},
    {"task_id": "edit-pdf", "traditional_reward": 0.889, "ontoskills_reward": 0.889, "traditional_passed": false, "ontoskills_passed": false},
    ...
    {"task_id": "flood-risk-analysis", "traditional_reward": 0.000, "ontoskills_reward": 0.000, "traditional_passed": false, "ontoskills_passed": false},
    {"task_id": "glm-lake-mendota", "traditional_reward": 0.000, "ontoskills_reward": 1.000, "traditional_passed": false, "ontoskills_passed": true},
    {"task_id": "invoice-fraud", "traditional_reward": 1.000, "ontoskills_reward": 1.000, "traditional_passed": true, "ontoskills_passed": true},
    {"task_id": "jax-computing", "traditional_reward": 1.000, "ontoskills_reward": 1.000, "traditional_passed": true, "ontoskills_passed": true},
    {"task_id": "jpg-ocr-stat", "traditional_reward": 0.000, "ontoskills_reward": 0.000, "traditional_passed": false, "ontoskills_passed": false},
    {"task_id": "multilingual-video", "traditional_reward": 0.000, "ontoskills_reward": 0.000, "traditional_passed": false, "ontoskills_passed": false},
    {"task_id": "pddl-tpp-planning", "traditional_reward": 0.500, "ontoskills_reward": 1.000, "traditional_passed": false, "ontoskills_passed": true},
    {"task_id": "protein-expression", "traditional_reward": 1.000, "ontoskills_reward": 1.000, "traditional_passed": true, "ontoskills_passed": true},
    {"task_id": "quantum-numerical", "traditional_reward": 1.000, "ontoskills_reward": 1.000, "traditional_passed": true, "ontoskills_passed": true},
    {"task_id": "r2r-mpc-control", "traditional_reward": 0.000, "ontoskills_reward": 0.000, "traditional_passed": false, "ontoskills_passed": false},
    {"task_id": "sales-pivot", "traditional_reward": 0.900, "ontoskills_reward": 0.000, "traditional_passed": false, "ontoskills_passed": false},
    {"task_id": "simpo-code", "traditional_reward": 0.000, "ontoskills_reward": 0.000, "traditional_passed": false, "ontoskills_passed": false},
    {"task_id": "spring-boot", "traditional_reward": 0.300, "ontoskills_reward": 0.300, "traditional_passed": false, "ontoskills_passed": false},
    {"task_id": "syzkaller-ppdev", "traditional_reward": 0.000, "ontoskills_reward": 0.714, "traditional_passed": false, "ontoskills_passed": false},
    {"task_id": "taxonomy-tree", "traditional_reward": 0.000, "ontoskills_reward": 0.000, "traditional_passed": false, "ontoskills_passed": false},
    {"task_id": "virtualhome-agent", "traditional_reward": 1.000, "ontoskills_reward": 1.000, "traditional_passed": true, "ontoskills_passed": true},
  ],
};
