...
.chip,.control,button{border:1px solid #3a4654;background:rgba(24,31,39,.92);color:#e8edf2;border-radius:6px;padding:8px 10px;box-shadow:0 8px 24px rgba(0,0,0,.2)}
...
const overlay=document.createElement('canvas');overlay.style.position='absolute';overlay.style.inset='0';overlay.style.cursor='grab';canvas.parentElement.appendChild(overlay);const ctx=overlay.getContext('2d');
